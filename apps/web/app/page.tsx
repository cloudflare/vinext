...
const PILLARS = [
  ...
  },
  {
    ...
    description:
      "Cloudflare Workers is the first deployment target, with one-command deploys via @vinext/cloudflare deploy. Vercel, Netlify, AWS, Deno Deploy, and more, work through Nitro, and standalone Node bundles are emitted on demand.",
  },
] as const;
