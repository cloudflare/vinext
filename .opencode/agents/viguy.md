...
- Before running any `gh` command that writes (comment, review, close, merge, create), confirm you are targeting the correct issue/PR number from your invocation context.
