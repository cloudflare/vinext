...
To opt into the Cloudflare Vite plugin v2 preview instead of the stable release, add
`--experimental-cloudflare-vite-plugin-v2`. The flag works with both `vinext init` and
`create-vinext-app`:

```bash
vinext init --platform=cloudflare --experimental-cloudflare-vite-plugin-v2
create-vinext-app my-app --platform=cloudflare --experimental-cloudflare-vite-plugin-v2
```
