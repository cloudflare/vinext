...
function areStaticParamsAllowed(
  ...
  // Next.js build/static-paths/app.ts compares runtime App Page params with
  // the encodedPathname form generated by encodeURIComponent(value). Route
  // matching is case-insensitive, so preserve that behavior for the encoded
  // comparison too.
