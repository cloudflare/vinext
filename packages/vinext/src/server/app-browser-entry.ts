      ...
      if (hasRscPayload && fetchResponse.body) {
        ...
        try {
          ...
          if (isServerActionResult(result)) {
            ...
            const navigationSnapshot = createClientNavigationRenderSnapshot(actionRedirect, params);
            ...
            startTransition(() => {
              ...
              if (redirectType === "push") {
                pushHistoryStateWithoutNotify(null, "", actionRedirect);
              } else {
                replaceHistoryStateWithoutNotify(null, "", actionRedirect);
              }
