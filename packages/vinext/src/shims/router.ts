...
async function performNavigation(
  ...
  const navState = {
    url:
      ...
      (interpolatedRoute.startsWith("#") ? currentAppUrl + interpolatedRoute : interpolatedRoute),
    as: credentialedDisplayHref ?? (resolved.startsWith("#") ? currentAppUrl + resolved : resolved),
