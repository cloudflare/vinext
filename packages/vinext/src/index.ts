...
function normalizeManifestModuleId(moduleId: string, root: string): string {
	...
	const isWindowsAbsolute =
		/^[a-zA-Z]:[\\/]/.test(moduleId) || moduleId.startsWith("\\\\");
...
export { staticExportApp, staticExportPages } from "./build/static-export.js";
