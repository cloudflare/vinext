...
// Virtual module that registers config-driven cache adapters (see
// VinextOptions.cache). Imported by the server entries; resolves to a no-op
// when no adapters are configured.
