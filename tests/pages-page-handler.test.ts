...
describe("createPagesPageHandler — request-aware App props", () => {
  ...
  it("marks getStaticProps HTML and data responses as private no-store", async () => {
    ...
    expect(html.headers.get(VINEXT_PRERENDER_SHARED_CACHE_BYPASS_HEADER)).toBeNull();
    ...
    expect(data.headers.get(VINEXT_PRERENDER_SHARED_CACHE_BYPASS_HEADER)).toBeNull();
  });
