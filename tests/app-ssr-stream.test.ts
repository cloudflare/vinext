...
describe("App SSR stream helpers", () => {
  describe("fixPreloadAs", () => {
    it("replaces as=\"stylesheet\" with as=\"style\" for preload links", () => {
      ...
      expect(
        fixPreloadAs('<link as="stylesheet" rel="preload" href="/file.css"/>'),
      ).toBe('<link as="style" rel="preload" href="/file.css"/>');
    });
    ...
    it("leaves non-preload links and other preload types unchanged", () => {
      ...
      expect(
        fixPreloadAs('<link rel="preload" href="/font.woff2" as="font"/>'),
      ).toBe('<link rel="preload" href="/font.woff2" as="font"/>');
  ...
  describe("fixFlightHints", () => {
    it("rewrites stylesheet hints in Flight HL records", () => {
      ...
      expect(
        fixFlightHints(
          '2:HL["/assets/index.css","stylesheet",{"crossOrigin":""}]',
        ),
