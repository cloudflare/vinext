...
describe("App Router RSC cache-busting", () => {
  ...
  it("exports the full Vary value for RSC-bearing App Router responses", () => {
    ...
    expect(VINEXT_RSC_VARY_HEADER).toBe(
      "RSC, Next-Router-State-Tree, Next-Router-Prefetch, Next-Router-Segment-Prefetch, Next-Url, X-Vinext-Interception-Context, X-Vinext-Mounted-Slots, X-Vinext-Mounted-Slot-Active-Routes, X-Vinext-Rsc-Render-Mode",
    );
